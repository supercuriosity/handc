...
class CoordinateSystemVisualizer:
    def __init__(self):
        ...
        self.combined_world_rotation = np.dot(z_rotation_world_counterclockwise_90, world_rotation)
    ...
    for frame_index, frame_state in enumerate(context.frame_loop()):
        ...
        if context.session_state == xr.SessionState.FOCUSED:
            ...
            for index, space in enumerate(tracker_action_spaces):
                ...
                z_rotation_counterclockwise_90 = np.array([
                    [0, -1, 0],
                    [1,  0, 0],
                    [0,  0, 1]
                ])
                ...
                # transformed_rotation_matrix = np.dot(transformed_rotation_matrix, z_rotation_clockwise_90)
                # transformed_rotation_matrix = np.dot(transformed_rotation_matrix, x_rotation_clockwise_90)
                # transformed_rotation_matrix = np.dot(transformed_rotation_matrix, z_rotation_counterclockwise_90)
